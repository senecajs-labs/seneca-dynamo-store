...
module.exports = function(options) {
  ...
  function configure(specification, cb) {
    ...
    connection = new aws.DynamoDB({
      ...
      accessKeyId: conf.keyid || conf.accessKey || conf.accessKeyId,
      secretAccessKey: conf.secret || conf.secretAccessKey,
      region: conf.region,
      apiVersion: conf.apiVersion,
      ciphers: conf.ciphers || "ALL",
      secureProtocol: conf.secureProtocol || "TLSv1_method",
    });
